...
from cntk import learners, io, logging, layers, Trainer, learning_rate_schedule
import _cntk_py
import cntk
import fire
...
def convnet_cifar10(num_convolution_layers=2, minibatch_size=64, max_epochs=30, debug_output=False):
